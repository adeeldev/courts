angular.module('TurkishApp')
	.controller('promotionController',['$scope','$uibModal', 'promotionService' , 'FileUploader' , '$location','$cookies','$rootScope', function ($scope, $uibModal, promotionService,  FileUploader, $location , $cookies, $rootScope){
    ...
    $scope.addSlot = function(courtId , slots){
            ...
            $location.path('/slots/' + courtId +'/'+slots);
    }; 
	/*********************************************************************/
